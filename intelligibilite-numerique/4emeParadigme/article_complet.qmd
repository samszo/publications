...
Une des fonctions très utiles d'Omeka S consiste à donner comme valeur d'une propriété une ressource présente dans la base de données. Ainsi, il est possible de créer des réseaux d'objects informatiques
