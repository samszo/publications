...
Nous concevons cet usage du diagramme comme la modélisation du point de vu d'un acteur sous la forme d'un état transitoire dans une "chronotopologie" [@ferri2021]. Encore faut-il définir quelles formes prend ce diagramme ? Quelles topologies sont à l'oeuvre dans sa construction ? Quelles analyses permettent-ils ?

## Modéliser l’écriture d’un article scientifique

Nous reprenons ici le modèle de diagramme que nous avons défini dans notre HDR...
